...
function crearFormularioSJF(){
    ...
    botonEnviarNumeroProcesos.textContent="Enviar";
    botonEnviarNumeroProcesos.addEventListener("click",()=>{
        mainContainer.appendChild(formularioTiemposProcesosSJF(parseInt(inputNumeroProcesos.value)));
        botonEnviarNumeroProcesos.disabled=true;
    })
    form.appendChild(inputNumeroProcesos);
    form.appendChild(botonEnviarNumeroProcesos);
...
function formularioTiemposProcesosSJF(numeroProcesos){
    ...
    formNumeroTiemposContainer.appendChild(crearCantidadTiemposSJF(numeroProcesos));
